...
export class Backend implements backendInterface {
    ...
    async getBackgroundMusicKey(): Promise<ExternalBlob | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getBackgroundMusicKey();
    ...
    async getCoupleInfo(): Promise<CoupleInfo> {
        if (this.processError) {
            try {
                const result = await this.actor.getCoupleInfo();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLoveLetter(): Promise<LoveLetter> {
        if (this.processError) {
            try {
    ...
    async getReasonsList(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getReasonsList();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTimelineMilestones(): Promise<Array<TimelineMilestone>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTimelineMilestones();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setBackgroundMusicKey(arg0: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setBackgroundMusicKey(await to_candid_ExternalBlob_n15(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateCoupleInfo(arg0: CoupleInfo): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateCoupleInfo(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateLoveLetter(arg0: LoveLetter): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateReasonsList(arg0: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateReasonsList(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTimelineMilestones(arg0: Array<TimelineMilestone>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateTimelineMilestones(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
